...
const LoginPage = async () => {
    ...
    return (
        <form onSubmit={handleSubmit(submitHandler)} className="w-screen h-screen flex justify-center items-center">
            <Card className='lg:w-1/3 md:w-3/4 flex flex-col shadow-md gap-5 w-full h-full md:h-[550px] px-6 py-8 md:py-8 rounded-xl'>
                ...
                <label className='text-slate-800 md:text-xl font-extrabold text-2xl text-center tracking-tight scroll-m-20'>Sign Up</label>
                ...
                <div className="flex flex-col md:gap-1 gap-2 md:mt-0">
                    ...
                    <Input {...register("userName")}  className='py-6 md:py-3 text-sm text-slate-700' placeholder='Ex. John Doe' />
                    <label className='text-slate-700 md:text-base font-extrabold text-xl tracking-tight scroll-m-20'>Email</label>
                    <Input {...register("email")}  className='py-6 md:py-3 text-sm text-slate-700' placeholder='johndoe@email.com' />
                    <label className='text-slate-700 md:text-base font-extrabold text-xl tracking-tight scroll-m-20'>Password</label>
                    <Input {...register("password")} type='password' name='password'  className='py-6 md:py-3 text-sm text-slate-700' placeholder='*********' />
                    <label className='text-slate-700 md:text-base font-extrabold text-xl tracking-tight scroll-m-20'>Repeat Password</label>
                    <Input  type='password' className='py-6 md:py-3 text-sm text-slate-700' placeholder='*********' />
