        ...
        <Card className={cn("shadow-md relative")}>
            ...
            <div className="px-6 flex gap-2">
                <div className="flex items-center gap-1">
                    <CalendarCheck2 className="dark:text-slate-200 text-slate-500" size={14} />
                    <p className="text-[.75rem] dark:text-slate-200 text-slate-500">Added:</p>
                    <p className="text-[.75rem] font-semibold dark:text-slate-300 text-slate-800">27 May</p>
                </div>
                <div className="flex items-center gap-1">
                    <CalendarCheck2 className="dark:text-slate-200 text-slate-500" size={14} />
                    <p className="text-[.75rem] dark:text-slate-200 text-slate-500">Deadline:</p>
                    <p className="text-[.75rem] font-semibold dark:text-slate-300 text-slate-800">27 May</p>
                </div>
            </div>
            <CardContent className="flex flex-col gap-1">
                ...
                <div className="flex flex-row items-center gap-2">
                    <p className="text-[.75rem] dark:text-slate-200 text-slate-500">Last updated: </p>
                    <p className="text-[.75rem] font-semibold dark:text-slate-300 text-slate-800">27 May</p>
                </div>
            </CardContent>
        </Card>
